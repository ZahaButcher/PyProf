...
let questions = [
  ...
  [
    ["Социальный работник", "S"],
    ["Администратор", "C"],
  ],
  [
    ["Тренер", "S"],
    ["Менеджер по продажам", "E"],
  ],
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  //   skala.style.width = `${((count + 1) / questions.length) * 100}%`;
